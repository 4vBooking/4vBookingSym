...
/**
 * @extends ServiceEntityRepository<Bungalow>
 *
...
class BungalowRepository extends ServiceEntityRepository
{
    ...
    public function save(Bungalow $entity, bool $flush = false): void
    {
    ...
    public function remove(Bungalow $entity, bool $flush = false): void
    {
